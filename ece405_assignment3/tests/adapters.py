...
def run_masked_normalize(
    ...
    return _masked_normalize(tensor, mask, normalize_constant=normalize_constant, dim=dim)


# ---------------------------------------------------------------------------
# Optional supplement adapters (instruction tuning, MMLU, GSM8K, DPO)
# ---------------------------------------------------------------------------
...
def get_packed_sft_dataset(
    ...
    from cs336_alignment.supplement import PackedSFTDataset
...
def run_parse_mmlu_response(
    ...
    # Look for the first occurrence of A/B/C/D possibly preceded by whitespace or newline
    m = re.search(r"\b([ABCD])\b", model_output.strip())
