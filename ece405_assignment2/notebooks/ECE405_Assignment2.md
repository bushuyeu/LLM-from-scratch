...
- **Note on content drift:** Record 13 (`3diasdemarzo.blogspot.com`) was a Spanish political blog in the WARC snapshot and correctly classified as non-nsfw. However, the live URL now redirects to an adult dating spam page — illustrating how crawl snapshots age and why re-crawled data may need reclassification.
