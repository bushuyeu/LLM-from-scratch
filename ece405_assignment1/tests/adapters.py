...
def run_linear(
    ...
    from ece496b_basics import Linear
...
def run_embedding(
    ...
    from ece496b_basics import Embedding
...
def run_swiglu(
    ...
    from ece496b_basics import SwiGLU
...
def run_multihead_self_attention(
    ...
    from ece496b_basics import MultiHeadSelfAttention

    mha = MultiHeadSelfAttention(d_model, num_heads, rope=None)
...
def run_multihead_self_attention_with_rope(
    ...
    from ece496b_basics import MultiHeadSelfAttention, RoPE
...
def run_rope(
    ...
    from ece496b_basics import RoPE
...
def run_transformer_block(
    ...
    from ece496b_basics import TransformerBlock, RoPE
...
def run_transformer_lm(
    ...
    from ece496b_basics import TransformerLM
...
def run_rmsnorm(
    ...
    from ece496b_basics import RMSNorm
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    from ece496b_basics import silu
...
def run_get_batch(
    ...
    from ece496b_basics import get_batch
...
def run_cross_entropy(
    ...
    from ece496b_basics import cross_entropy

    return cross_entropy(inputs, targets)


def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    from ece496b_basics import gradient_clipping

    gradient_clipping(parameters, max_l2_norm)


def get_adamw_cls() -> Any:
    from ece496b_basics import AdamW
...
def run_get_lr_cosine_schedule(
    ...
    from ece496b_basics import get_lr_cosine_schedule
...
def run_save_checkpoint(
    ...
    from ece496b_basics import save_checkpoint
...
def run_load_checkpoint(
    ...
    from ece496b_basics import load_checkpoint
